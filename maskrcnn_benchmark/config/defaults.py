...
_C.MODEL.FEW_SHOT = CN()
_C.MODEL.FEW_SHOT.ScaleCls = 10
...
_C.MODEL.ROI_BOX_HEAD.NUM_CLASSES = 141
...
_C.MODEL.ROI_MASK_HEAD.USE_BBOX2MASK = False
_C.MODEL.ROI_MASK_HEAD.USE_MLPMASK = False
...
_C.MODEL.RETINANET.NUM_CLASSES = 141
